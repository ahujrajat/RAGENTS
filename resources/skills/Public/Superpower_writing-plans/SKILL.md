...
> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:Superpower_subagent-driven-development (recommended) or superpowers:Superpower_executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.
...
- **REQUIRED SUB-SKILL:** Use superpowers:Superpower_subagent-driven-development
- Fresh subagent per task + two-stage review

**If Inline Execution chosen:**
- **REQUIRED SUB-SKILL:** Use superpowers:Superpower_executing-plans
