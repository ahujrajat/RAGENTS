---
name: Superpower_requesting-code-review
...
Dispatch superpowers:Superpower_code-reviewer subagent to catch issues before they cascade. The reviewer gets precisely crafted context for evaluation — never your session's history. This keeps the reviewer focused on the work product, not your thought process, and preserves your own context for continued work.
...
Use Task tool with superpowers:Superpower_code-reviewer type, fill template at `code-reviewer.md`
...
[Dispatch superpowers:Superpower_code-reviewer subagent]
