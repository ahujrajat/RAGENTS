---
name: Superpower_systematic-debugging
...
1. **Create Failing Test Case**
   ...
   - Use the `superpowers:Superpower_test-driven-development` skill for writing proper failing tests
...
**Related skills:**
- **superpowers:Superpower_test-driven-development** - For creating failing test case (Phase 4, Step 1)
- **superpowers:Superpower_verification-before-completion** - Verify fix worked before claiming success
